 ...
 * @returns {function}
 * */
export function _debounce(callback, delay = 500, immediate = false) {
  var timer;
  return function () {
    // if(immediate) {
 ...
 * @returns {function}
 * */
export function _throttle(callback, interval = 500) {
  var last, timer;
  ...
  return () => {
    ...
    if (last && now - last < interval) {  // 
      ...
      timer = setTimeout(() => {
        last = now;
        console.log(1, now / 1000)
        callback.apply(this, arguments);
      }, interval);
    } else {
      last = now;
      console.log(2, now / 1000)
      callback.apply(this, arguments);
    }
  }
}
